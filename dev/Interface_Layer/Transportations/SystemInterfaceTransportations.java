...
//    private Drivers_Controller drivers_controller = Drivers_Controller.getInstance();
    ...
    public List<String> getFreeTrucks(Date date) throws Buisness_Exception {
        return service.trucks_controller.getFreeTrucks(date);
    }
    ...
    public void createTransportation(Date date, LocalTime leaving_time, int driver_id,
        ...
        service.transportation_controller.createTransportation(date, leaving_time, driver_id,
    ...
    public void createRegularTransportation(Date date, LocalTime leaving_time, int driver_id,
        ...
        service.transportation_controller.createRegularTransportation(date, leaving_time, driver_id,
    ...
    public Date Free_truck_and_driver(int transportationID) throws Buisness_Exception {
...
//        boolean result = site_controller.addsupplier(name, city, street, number, name_of_contact, phone, area);
//        if (result) {
